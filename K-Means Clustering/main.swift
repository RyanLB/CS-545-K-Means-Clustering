...
let exp1Labels = exp1Set.clusterLabelsFromData(trainingData)
var trainingResults = exp1Set.testOnData(trainingData, withClusterLabels: exp1Labels)
...
var exp1Results = exp1Set.testOnData(testData, withClusterLabels: exp1Labels)
...
let exp2Labels = exp2Set.clusterLabelsFromData(trainingData)
trainingResults = exp2Set.testOnData(trainingData, withClusterLabels: exp2Labels)
print("Training SSE: \(trainingResults.sumSquaredError)")
print("Training SSS: \(trainingResults.sumSquaredDistance)")
print("Mean entropy: \(trainingResults.meanEntropy)")
var exp2Results = exp2Set.testOnData(testData, withClusterLabels: exp2Labels)
